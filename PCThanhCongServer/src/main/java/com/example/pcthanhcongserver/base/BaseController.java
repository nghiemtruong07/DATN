package com.example.pcthanhcongserver.base;

import com.example.pcthanhcongserver.contants.Common;
import com.example.pcthanhcongserver.dto.ResponseDTO;
import com.example.pcthanhcongserver.dto.pagination.PaginateDTO;
import com.example.pcthanhcongserver.dto.pagination.PaginationDTO;
import com.example.pcthanhcongserver.dto.pagination.PaginationResponseDTO;
...
public class BaseController<T> {
    ...
    public ResponseEntity<?> resPagination(PaginateDTO<?> paginateDTO) {
        PaginationDTO<List<?>> paginationDTO = new PaginationDTO<>(paginateDTO.getPageData().getContent(),paginateDTO.getPagination());
